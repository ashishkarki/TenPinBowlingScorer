...
class ScoreProcessorTest {
    ...
    void calculateTotalScore_gets_correctScore() {
        ...
        final int lastFrameStart2 = 17;
        final int expectedTotalScore2 = 103;

        assertTrue(
                scoreProcessor.calculateTotalScore(sampleScoredRolls1, lastFrameStart1)
                        == expectedTotalScore1);
        assertTrue(
                scoreProcessor.calculateTotalScore(sampleScoredRolls2, lastFrameStart2)
                        == expectedTotalScore2);
    }
}